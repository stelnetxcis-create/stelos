...
Item {
    ...
    property string style: Config.options.background.widgets.clock_cookie.dateStyle
    ...
    readonly property bool timeIndicators: Config.options.background.widgets.clock_cookie.timeIndicators

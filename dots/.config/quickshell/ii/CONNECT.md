...
**Connect Mode** is a unified interface architecture for Quickshell. Unlike the traditional mode (`default`), where each panel (Bar, Frame, Dashboard, Policies) is rendered in a separate `PanelWindow` (Wayland surface), Connect Mode consolidates all of these components into a **single transparent fullscreen surface** ([TopLayerPanel.qml](file:///home/xenna/.config/quickshell/ii/modules/ii/topLayer/TopLayerPanel.qml)).
...
3. **Fluid Animations:** The visual shrinking of the frame ([WrappedFrameVisuals.qml](file:///home/xenna/.config/quickshell/ii/modules/ii/wrappedFrame/WrappedFrameVisuals.qml)) and the movement of the sidebars occur via internal QML transitions synchronized.
...
Since [TopLayerPanel.qml](file:///home/xenna/.config/quickshell/ii/modules/ii/topLayer/TopLayerPanel.qml) is a fullscreen window, it would normally capture all mouse input, preventing the user from clicking on application windows behind it. 
...
The system state is dynamically evaluated in [GlobalStates.qml](file:///home/xenna/.config/quickshell/ii/GlobalStates.qml):
...
#### [Config.qml](file:///home/xenna/.config/quickshell/ii/modules/common/Config.qml) (Modified)
...
#### [GlobalStates.qml](file:///home/xenna/.config/quickshell/ii/GlobalStates.qml) (Modified)
...
#### [InterfaceConfig.qml](file:///home/xenna/.config/quickshell/ii/modules/settings/InterfaceConfig.qml) (Modified)
...
#### [IllogicalImpulseFamily.qml](file:///home/xenna/.config/quickshell/ii/panelFamilies/IllogicalImpulseFamily.qml) (Modified)
...
#### [Bar.qml](file:///home/xenna/.config/quickshell/ii/modules/ii/bar/Bar.qml) and [VerticalBar.qml](file:///home/xenna/.config/quickshell/ii/modules/ii/verticalBar/VerticalBar.qml) (Modified)
...
#### [SidebarPolicies.qml](file:///home/xenna/.config/quickshell/ii/modules/ii/sidebarPolicies/SidebarPolicies.qml) (Modified)
...
#### [SidebarDashboard.qml](file:///home/xenna/.config/quickshell/ii/modules/ii/sidebarDashboard/SidebarDashboard.qml) (Modified)
...
#### [TopLayer.qml](file:///home/xenna/.config/quickshell/ii/modules/ii/topLayer/TopLayer.qml) (NEW)
...
#### [TopLayerPanel.qml](file:///home/xenna/.config/quickshell/ii/modules/ii/topLayer/TopLayerPanel.qml) (NEW)
...
#### [WrappedFrameVisuals.qml](file:///home/xenna/.config/quickshell/ii/modules/ii/wrappedFrame/WrappedFrameVisuals.qml) (Modified)
...
#### [SidebarDashboardContent.qml](file:///home/xenna/.config/quickshell/ii/modules/ii/sidebarDashboard/SidebarDashboardContent.qml) (Modified)
...
To prevent active windows from tiling over the status bar, [TopLayer.qml](file:///home/xenna/.config/quickshell/ii/modules/ii/topLayer/TopLayer.qml) instantiates transparent, invisible `PanelWindow`s (`hBarSpaceReserver` and `vBarSpaceReserver`) with `exclusionMode: ExclusionMode.Normal`.
...
- The corner loaders in [TopLayerPanel.qml](file:///home/xenna/.config/quickshell/ii/modules/ii/topLayer/TopLayerPanel.qml) (`leftSidebarTopCornerLoader`, etc.) are **disabled** (`active: ... && fakeScreenRounding != 3`).
- Instead, [WrappedFrameVisuals.qml](file:///home/xenna/.config/quickshell/ii/modules/ii/wrappedFrame/WrappedFrameVisuals.qml) handles the visual corner transitions using its own `RoundCorner` components (`bottomLeftCorner`, etc.), which shift dynamically along with the sidebar offset. This prevents overlapping transparencies and double-blur artifacts.
...
- The corner loaders in [TopLayerPanel.qml](file:///home/xenna/.config/quickshell/ii/modules/ii/topLayer/TopLayerPanel.qml) are **activated**.
